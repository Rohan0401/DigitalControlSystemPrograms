%  Figure 6.4c     Digital Control of Dynamic Systems, 3e
...
%  rad/s using sample period 2.0  and Bilinear,
...
grid,title('Fig. 6.4c  Magnitude and phase of discrete equivalents, T=2'), 
hold off

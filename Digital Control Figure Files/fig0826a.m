%  Figure 8.26a     Digital Control of Dynamic Systems, 3e 
...
[num]=ss2zp(phic,B,[0 1 0],[0 0],1) % see where zero is
...
ylabel('OUTPUTS')
xlabel('Time (sec)')
title('Fig. 8.26a Response with integral control, Example 8.16')

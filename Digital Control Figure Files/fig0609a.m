%  Figure 6.9a     Digital Control of Dynamic Systems, 3e
%                  Franklin, Powell, Workman
%                  Addison-Wesley, Publishing Company, 1998
% Matlab 4.2 or 5.0
%
% computes Fig. 6.9(a)  which compares
% the zero-order-hold, the triangle hold, and the
% zero-pole equivalents for the third order Butterworth
% filter with unity (rad) bandwidth and sample period T =1.
% The responses are
...
plot(wn,magzoh,'o',wn,magzp,'+',wn,magtri,'x')
 title('Fig. 6.9a  (zoh = o, zero-pole = + ,triangle = x)')
hold off

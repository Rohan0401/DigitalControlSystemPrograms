%  Figure 6.4a     Digital Control of Dynamic Systems, 3e
...
%  rad/s using sample period .1  and Bilinear,
...
grid,title('Fig. 6.4a  Magnitude and phase of discrete equivalents,T=0.1'), 
hold off
